...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWTY] = LAYOUT(
    ...
    SC_V,     KC_LCTL,   KC_LALT, MO(_FUN),  KC_TAB,  KC_END,    KC_PGDN, KC_SPC,  MO(_NUM),  KC_ENT,   KC_RCTL, MT_ESC
  ),
  [_NUM] = LAYOUT(
    _______,  KC_1,     KC_2,  KC_3,     KC_GRV,                       KC_DEL,   SC_AC,    SC_OUT,   SC_IN,   KC_BSPC,
    _______,  KC_4,     KC_5,  KC_6,     _______,                      KC_LEFT,  KC_DOWN,  KC_UP,    KC_RIGHT,  SC_RFH,
  ...
  [_FUN] = LAYOUT(
    KC_CAPS,  KC_F1,    KC_F2,    KC_F3,    KC_F10,                       _______,  KC_MINS,  KC_EQL,   KC_UNDS,  KC_PLUS,
