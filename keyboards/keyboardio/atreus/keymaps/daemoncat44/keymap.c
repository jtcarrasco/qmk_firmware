...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWTY] = LAYOUT(
    ...
    MT_Z,     MT_X,      KC_C,    KC_V,      KC_B,    KC_F4,    KC_TAB,   KC_N,    KC_M,      KC_COMM,  MT_RP,    MT_RS,
    KC_PGUP,  KC_F6,     KC_LALT, MO(_FUN),  KC_ESC,  KC_F5,    KC_F1,    KC_SPC,  MO(_NUM),  MT_ENT,   KC_F2,    KC_PGDN
  ),
  [_NUM] = LAYOUT(
