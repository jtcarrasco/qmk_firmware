...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWTY] = LAYOUT(
    ...
    MT_Z,     MT_X,      KC_C,    KC_V,      KC_B,    XXXXXXX,  KC_TAB,   KC_N,    KC_M,      KC_COMM,  MT_RP,    MT_RS,
    KCPGUP,   KC_F4,     KC_LALT, MO(_FUN),  KC_ESC,  XXXXXXX,  KC_F1,    KC_SPC,  MO(_NUM),  MT_ENT,   KC_F3,    KC_PGDN
  ),
  [_NUM] = LAYOUT(
    ...
    XXXXXXX,  XXXXXXX,  KC_0,  KC_TRNS,  KC_TRNS,  XXXXXXX,  XXXXXXX,  KC_TRNS,  KC_TRNS,  KC_TRNS,  XXXXXXX,   XXXXXXX
  ),
  [_FUN] = LAYOUT(
