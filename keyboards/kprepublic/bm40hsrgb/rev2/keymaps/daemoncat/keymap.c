...
[_QWERTY] = LAYOUT_ortho_4x12_1x2uC(
    ...
    KC_F2,   KC_LCTL, KC_LALT, KC_F3, TL_LOWR,      KC_SPC,        TL_UPPR, KC_RGUI, KC_RALT, KC_RCTL, SC_FLW
),
...
[_RAISE] = LAYOUT_ortho_4x12_1x2uC(
    _______, _______, _______, _______, _______, _______, _______, SC_AC,   SC_OUT,  SC_IN,   _______, SC_DEL,
