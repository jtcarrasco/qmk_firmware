 ...
 * |--------+--------+--------+--------+--------+--------+-------+--------+--------+--------+--------+--------+-------+--------+----------|
 * |  LALT   | LGUI  | LALT 	|	FIND   | CMD T  | SPACE  | SPACE | APP    | FN-MO  | RALT   | RGUI   | RCTRL  | LEFT  | DOWN   | RIGHT    |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
 	...
 	[_QW_M] = LAYOUT_ortho_5x15( /* QWERTY MAC*/
  	...
  	KC_LCTL,  KC_LALT,  KC_LGUI,	LGUI(KC_F), LGUI(KC_T), KC_NO, KC_SPC, 	LALT(KC_SPACE),	MO(_FN), 	KC_RGUI,  KC_RALT,  KC_RCTL,    KC_LEFT,    KC_DOWN,     KC_RGHT \
	),
  ...
  */
  ...
  [_QW_W] =  LAYOUT_ortho_5x15( /* QWERTY WIN*/
  	...
  	KC_LCTL,  KC_LALT,  KC_LGUI,  LCTL(KC_F), 	LCTL(KC_T), KC_NO, KC_SPC,	LALT(KC_SPACE),	MO(_FN), 	LGUI(KC_TAB),  KC_RALT,  KC_RCTL,     KC_LEFT,    KC_DOWN,     KC_RGHT \
 	),
	...
	* |--------+--------+--------+--------+--------+--------+-------+--------+--------+--------+--------+--------+---------+--------+----------|
	* | TAB    | QW_Q   | WIN    | -      | -      | RGB_TOG| -     | -      | OPTION | -      | -      | [       | ]      | ALTTAB | WIN TAB  |
	* |--------+--------+--------+--------+--------+--------+-------+--------+--------+--------+--------+---------+--------+--------+----------|
	* | CAP LK | MAC    | RAINBOW| PLAIN  | -      | -     | -      | -      | -      | -      | ;      | `       | ENTER  |  ENTER | REF      |
	* |--------+--------+--------+--------+--------+-------+--------+--------+--------+--------+--------+---------+--------+--------+----------|
	* | LSHIFT | INC    | DEC    | HUE I  | HUE D  | SAT I | SAT D  | -      | -      | .      | /      | \       | RSHIFT | HOME   | SAVE     |
	* |--------+--------+--------+--------+--------+-------+--------+--------+--------+--------+--------+---------+--------+--------+----------|
	* | LALT   | LGUI   | LALT   |  FIND  | CMD T	 | SPACE | SPACE  | APP    | FN-MO  | RALT   | RGUI   |  RCTRL  | PGUP   | END    | PGDN     |
	* '----------------------------------------------------------------------------------------------------------------------------------------'
	*/
	...
	[_FN] = LAYOUT_ortho_5x15( /* OSLAYOUT + NUMPAD + MEDIA + LIGHTING */
  	...
  	KC_TRNS, DF(_QW_Q), DF(_QW_W),    		 KC_NO,    		   KC_NO,   RGB_TOG, KC_NO,   KC_NO,   KC_RALT, KC_NO,   KC_NO,   KC_LBRC, KC_RBRC, LALT(KC_TAB), LGUI(KC_TAB), \
  	KC_TRNS, DF(_QW_M), RGB_MODE_RAINBOW,  RGB_MODE_PLAIN, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_TRNS, KC_GRV,  KC_TRNS, KC_TRNS, 			KC_TRNS, \
