...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_QW_M] = LAYOUT_ortho_5x15( /* QWERTY MAC*/
	  ...
	  * | TAB    | Q      | W      | E      | R      | T     | Y      | U    | I      | O      | P      | {      | }     | Copy   | Paste    |
	  * |--------+--------+--------+--------+--------+-------+--------+------+--------+--------+--------+--------+-------+--------+----------|
	  * | CAP LK | A      | S      | D      | F      | G     | H      | J    | K      | L      | ;      | '      | REF   | ENTER  | ENTER    |
	  * |--------+--------+--------+--------+--------+-------+--------+------+--------+--------+--------+--------+-------+--------+----------|
	  * | LSHIFT | Z      | X      | C      | V      | B     | N      | M    | ,      | .      | /      | \      | RSHIFT| UP     | SAVE     |
	  * |--------+--------+--------+--------+--------+-------+--------+------+--------+--------+--------+--------+-------+--------+----------|
	  * | LALT   | LGUI   | LALT   |  FIND  | CMD T	 | SPACE | SPACE  | APP	 | FN-MO  | RALT   | RGUI   | RCTRL  | LEFT  | DOWN   | RIGHT    |
  ...
  [_QW_W] = LAYOUT_ortho_5x15( /* QWERTY WIN*/
	...
	* |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
	* | TAB    | -      | WIN    | -      | -      | RGB_TOG| -      | -      | OPTION | -  	  | -      | [      | ]    	 | ALTTAB | WINTAB |
	* |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
	* | CAP LK | MAC    | RAINBOW| PLAIN  | -      | -      | -      | -      | -      | -      | ;      | `      | REF  	 | ENTER  | ENTER  |
	* |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
	...
	*/
 	...
 	[_FN] = LAYOUT_ortho_5x15( /* OSLAYOUT + NUMPAD + MEDIA + LIGHTING */
  	...
  	KC_TRNS, KC_NO,     DF(_QW_W),    		 KC_NO,    		   KC_NO,   RGB_TOG, KC_NO,   KC_NO,   KC_RALT, KC_NO,   KC_NO,   KC_LBRC, KC_RBRC, LALT(KC_TAB), LGUI(KC_TAB), \
